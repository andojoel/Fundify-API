...
public class UserEndpoints : ICarterModule
{
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        var emailSender = app.ServiceProvider.GetRequiredService<IEmailSender<User>>();
        ...
        routeGroup.MapPost("/register", async Task<Results<Ok<RequestDto>, ValidationProblem>>
            ([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                throw new NotSupportedException($"AddRoutes requires a user store with email support.");
            }
            ...
            var response = RequestDto.Success($"{email} registered.");
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"AddRoute-{finalPattern}";
