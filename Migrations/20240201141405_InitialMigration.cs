...
namespace Fundify_API.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceChangePercentage_24h = table.Column<double>(type: "double", nullable: true),
                    Image = table.Column<string>(type: "longtext", nullable: true),
                    Name = table.Column<string>(type: "longtext", nullable: false),
                    Symbol = table.Column<string>(type: "longtext", nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    OwnerUsername = table.Column<string>(type: "longtext", nullable: true),
                    WalletId = table.Column<Guid>(type: "char(36)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CryptoCurrencyTable", x => x.Id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
